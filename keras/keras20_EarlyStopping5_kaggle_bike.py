...
y = train_csv['count']
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.85, random_state=3124)
x_train,x_val,y_train,y_val = train_test_split(x_train,y_train,train_size=70/85, random_state=1231)
...
random_state        :   3124
train_size          :   0.7
list_percepticon    :   [10,10,10,10,10,10,1]
epochs              :   10000
batch_size          :   8
RMSE value          :   147.9581
"""
