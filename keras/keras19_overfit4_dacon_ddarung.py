...
x_train, x_test, y_train, y_test = train_test_split(x, y, train_size=0.75, random_state=915124)
...
hist = model.fit(x_train, y_train, epochs=1500, batch_size=50 , verbose = 1, validation_split = 0.33)
end_time = time.time()
...
submission.to_csv(path + "submit/" + "submit_0907_1334.csv")
