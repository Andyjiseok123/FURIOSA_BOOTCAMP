...
np.save(np_path+'keras49_01_x_train.npy', arr=x_train)
np.save(np_path+'keras49_01_y_train.npy', arr=y_train)
np.save(np_path+'keras49_01_x_test.npy', arr=x_test)
np.save(np_path+'keras49_01_y_test.npy', arr=y_test)
