...
#2. 모델 구성
model = Sequential()
model.add(Conv2D(256, (3,3),padding='same', input_shape = (32,32,3)))                      #(26,26,64)
model.add(MaxPooling2D())
model.add(Conv2D(filters=128 , kernel_size=(3,3),padding='same', activation='relu'))        #(24,24,32)
...
# accuraccy_score:  0.6876
# 소요시간 :  747.07 초

# accuraccy_score:  0.3342
# 소요시간 :  382.35 초