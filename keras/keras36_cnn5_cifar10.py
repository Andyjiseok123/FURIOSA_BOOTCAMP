...
#2. 모델 구성
model = Sequential()
model.add(Conv2D(64, (5,5), input_shape = (32,32,3)))                      #(26,26,64)
model.add(Conv2D(filters=32 , kernel_size=(5,5), activation='relu'))        #(24,24,32)
model.add(Dropout(0.5))
model.add(Conv2D(32,(3,3),activation='relu'))                               #(23,23,32)
model.add(Conv2D(32,(3,3),activation='relu'))                               #(22,22,16)
model.add(Dropout(0.4))
model.add(Conv2D(32,(2,2),activation='relu'))                               #(21,21,16)
