...
model.load_weights(path + 'keras29_5_save_weights2.weights.h5') #가중치 불러오기
# model.save(path + 'keras29_1_save_model.keras') #모델 세이브
...
# model.save_weights(path + 'keras29_5_save_weights2.weights.h5') #가중치 세이브
